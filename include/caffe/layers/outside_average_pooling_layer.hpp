#ifndef CAFFE_OUTSIDE_AVERAGE_POOLING_LAYER_HPP_
#define CAFFE_OUTSIDE_AVERAGE_POOLING_LAYER_HPP_
...
class OutsideAveragePoolingLayer : public Layer<Dtype> {
 public:
  explicit OutsideAveragePoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "OutsideAveragePooling"; }
...
#endif  // CAFFE_OUTSIDE_AVERAGE_POOLING_LAYER_HPP_
